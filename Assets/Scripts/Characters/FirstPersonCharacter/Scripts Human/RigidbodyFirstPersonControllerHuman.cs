...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonControllerHuman : MonoBehaviour
    {
        [Serializable]
        ...
        public MouseLookHuman MouseLookHuman = new MouseLookHuman();
        ...
        private void Start()
        {
            ...
            MouseLookHuman.Init (transform, cam.transform);
        }
        ...
        private Vector2 GetInput()
        {
            ...
            var input = new Vector2
                {
                    x = CrossPlatformInputManager.GetAxis(ButtonNames.CameraHumanX),
                    y = CrossPlatformInputManager.GetAxis(ButtonNames.CameraHumanY)
                };
        ...
        private void RotateView()
        {
            ...
            MouseLookHuman.LookRotation (transform, cam.transform);
