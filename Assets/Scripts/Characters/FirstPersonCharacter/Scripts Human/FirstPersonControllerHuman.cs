...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonControllerHuman : MonoBehaviour
    {
        ...
        [SerializeField] private MouseLookHuman _mMouseLookHuman;
        [SerializeField] private bool m_UseFovKick;
        [SerializeField] private FOVKick m_FovKick = new FOVKick();
        [SerializeField] private bool m_UseHeadBob;
        [SerializeField] private CurveControlledBobHuman m_HeadBob = new CurveControlledBobHuman();
        ...
        private void Start()
        {
			...
			_mMouseLookHuman.Init(transform , m_Camera.transform);
        }
        ...
        private void FixedUpdate()
        {
            ...
            _mMouseLookHuman.UpdateCursorLock();
        }
        ...
        {
            _mMouseLookHuman.LookRotation (transform, m_Camera.transform);
        }
