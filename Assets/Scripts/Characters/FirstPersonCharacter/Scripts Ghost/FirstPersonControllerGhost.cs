...
namespace UnityStandardAssets.Characters.FirstPerson {
    ...
    public class FirstPersonControllerGhost : MonoBehaviour {
        ...
        [SerializeField] private MouseLookGhost _mMouseLookGhost;
        [SerializeField] private bool m_UseFovKick;
        [SerializeField] private FOVKick m_FovKick = new FOVKick();
        [SerializeField] private bool m_UseHeadBob;
        [SerializeField] private CurveControlledBobGhost m_HeadBob = new CurveControlledBobGhost();
        ...
        private void Start() {
            ...
            _mMouseLookGhost.Init(transform, m_Camera.transform);
        }
        ...
        private void FixedUpdate() {
            ...
            _mMouseLookGhost.UpdateCursorLock();
        }
        ...
        private void GetInput(out float speed) {
            ...
            // Read input
            var horizontal = CrossPlatformInputManager.GetAxis(ButtonNames.MoveGhostX);
            var vertical = CrossPlatformInputManager.GetAxis(ButtonNames.MoveGhostY);
        ...
        private void RotateView() {
            _mMouseLookGhost.LookRotation(transform, m_Camera.transform);
        }
