...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonControllerGhost : MonoBehaviour
    {
        [Serializable]
        ...
        public MouseLookGhost MouseLookGhost = new MouseLookGhost();
        ...
        private void Start()
        {
            ...
            MouseLookGhost.Init (transform, cam.transform);
        }
        ...
        private void StickToGroundHelper()
        {
            ...
            if (Physics.SphereCast(transform.position, m_Capsule.radius * (1.0f - advancedSettings.shellOffset), Vector3.down, out hitInfo,
                ...
                if (Mathf.Abs(Vector3.Angle(hitInfo.normal, Vector3.up)) < 85f) m_RigidBody.velocity = Vector3.ProjectOnPlane(m_RigidBody.velocity, hitInfo.normal);
        }
        ...
        private Vector2 GetInput()
        {
            ...
            var input = new Vector2
                {
                    x = CrossPlatformInputManager.GetAxis(ButtonNames.CameraGhostX),
                    y = CrossPlatformInputManager.GetAxis(ButtonNames.CameraGhostY)
                };
        ...
        private void RotateView()
        {
            ...
            MouseLookGhost.LookRotation (transform, cam.transform);
